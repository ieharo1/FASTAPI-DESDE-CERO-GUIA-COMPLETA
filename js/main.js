// Main JavaScript para FastAPI & n8n Desde Cero

document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 FastAPI & n8n Desde Cero - Sitio cargado correctamente');
    ...
    window.addEventListener('scroll', () => {
        ...
        if (window.pageYOffset > 100) {
            header.style.background = 'rgba(0, 105, 96, 0.98)';
            header.style.boxShadow = '0 4px 30px rgba(0, 150, 136, 0.3)';
        } else {
    ...
    console.log('%c🚀 ¡Bienvenido a FastAPI & n8n Desde Cero!', 'font-size: 20px; color: #009688; font-weight: bold;');
});
