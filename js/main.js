// Main JavaScript para FastAPI Desde Cero

document.addEventListener('DOMContentLoaded', function() {
    console.log('☕ FastAPI Desde Cero - Sitio cargado correctamente');
    ...
    console.log('%c☕ ¡Bienvenido a FastAPI Desde Cero!', 'font-size: 20px; color: #009688; font-weight: bold;');
});
